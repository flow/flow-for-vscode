...
export async function activate(context: vscode.ExtensionContext) {
  ...
  const defaultErrorHandler: lsp.ErrorHandler = client.createDefaultErrorHandler();

  client.registerFeature(new TypeCoverageFeature(client));
  if (isFlowStatusEnabled()) {
