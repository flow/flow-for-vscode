...
export function setupDiagnostics(context: ExtensionContext): void {
  ...
  if (vscode.window.activeTextEditor &&
      hasFlowPragma(vscode.window.activeTextEditor.document.getText())) {
  ...
  subscriptions.push(
    vscode.workspace.onDidChangeTextDocument(event => {
      const isDocumentActive = vscode.window.activeTextEditor && event &&
                               vscode.window.activeTextEditor.document.fileName === event.document.fileName;
