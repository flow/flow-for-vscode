...
function filterJs({languageId}){
  return languageId === 'javascript';
}

function filterCss({languageId}){
  return languageId === 'css';
}

function findActFolder(activeDoc){
...
function getPathToFlow(): Promise<string> {
  const workspaceRoot = calcWorkspaceRoot();
