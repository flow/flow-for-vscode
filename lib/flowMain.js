...
import {checkNode, checkFlow} from './utils'
...
export function activate(context: Context): void {
	...
	context.subscriptions.push(vscode.languages.registerCompletionItemProvider({ language: 'javascript', scheme: 'file' }, new CompletionSupport(), '.'));
